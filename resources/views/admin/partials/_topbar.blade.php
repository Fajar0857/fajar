<header class="topbar" data-navbarbg="skin6"style="background-image: linear-gradient(grey,white);">
    <nav class="navbar top-navbar navbar-expand-lg">
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                <!-- Logo icon -->
                <a href="/" class="mt-5 ms-3">
                    <img src="{{asset('images/rpl.png')}}" width="100%" alt="">
            ...
            <ul class="navbar-nav float-end ms-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="ms-2 d-none d-lg-inline-block"><span>Selamat Datang,</span> <span class="text-dark">{{ Auth::user()->name }}</span> <i data-feather="chevron-down" class="svg-icon"></i></span>
                    </a>
