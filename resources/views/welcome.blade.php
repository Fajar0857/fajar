...
<head class="bg-light mt-4"style="background-image: linear-gradient(red,yellow);">
    <meta charset="utf-8">
...
<body style="background-image: linear-gradient(white,purple,red,yellow,orange,red,black);">
    ...
    <div class="container mt-4">
        <h2 class="text-center mb-4"><span class="text-light">Galeri Kegiatan</span></h2>
    ...
    <div class="container mt-4">
        <hr>
        <h2 class="text-center mb-4"><span class="text-light">Peta Sekolah</span></h2>
    ...
    <footer class="bg-light mt-4"style="background-image: linear-gradient(grey,white);">
        <div class="container text-center py-4">
            <p>&copy; 2024 <a href="https://instagram.com/smkalhafidzleuwiliang" target="_blank">  SMK Al Hafidz Leuwiliang</a> </p>
        </div>
    </footer>
